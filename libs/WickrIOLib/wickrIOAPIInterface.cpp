...
bool
WickrIOAPIInterface::startAsyncMessages(QString& responseString)
{
    m_processAsyncMessages = true;
    return true;
}

bool
WickrIOAPIInterface::stopAsyncMessages(QString& responseString)
{
    m_processAsyncMessages = false;
    return true;
}

bool
WickrIOAPIInterface::startAsyncEvents(QString& responseString)
{
    m_processAsyncEvents = true;
    return true;
}

bool
WickrIOAPIInterface::stopAsyncEvents(QString& responseString)
{
    m_processAsyncEvents = false;
    return true;
}
