...
#define WBIO_CLIENT_TARGET          "widkrio_botOnPrem"

#elif defined(WICKR_BETA)
#define WBIO_CLIENT_TARGET          "widkrio_botBeta"

#elif defined(WICKR_ALPHA)
#define WBIO_CLIENT_TARGET          "widkrio_botAlpha"

#elif defined(WICKR_PRODUCTION)
#define WBIO_CLIENT_TARGET          "widkrio_bot"

#elif defined(WICKR_QA)
#define WBIO_CLIENT_TARGET          "widkrio_botQA"
