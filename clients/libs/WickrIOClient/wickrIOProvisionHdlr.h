...
signals:
    ...
    void signalRegisterCloud(const QString &userId, const QString &password, const QString &transactionid, bool newUser, bool sync, bool isRekey);
...
private:
    ...
    bool provisionBotUser(Mode mode);
