...
CONFIG(release,release|debug) {
    ...
    wickr_blackout:TARGET = core_botOnPrm
    else:wickr_beta:TARGET = core_botBeta
    else:TARGET = core_botAlpha
...
linux-g++* {
    CONFIG(release,release|debug) {
        QMAKE_RPATHDIR += /usr/lib/wio_core_bot
    }
    else {
        wickr_blackout:QMAKE_RPATHDIR = /usr/lib/wio_core_bot-onprem
        else:wickr_beta:QMAKE_RPATHDIR = /usr/lib/wio_core_bot-beta
        else:QMAKE_RPATHDIR = /usr/lib/wio_core_bot-alpha
    }
